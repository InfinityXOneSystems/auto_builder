    ...
    if r.status_code != 200:
        ...
        for agent in team:
            ...
            try:
                ...
                r2 = requests.post(gateway + '/api/agents/headless_team/execute', json=payload, timeout=15)
                print('->', r2.status_code, r2.text[:1000])
                out['results'].append({'agent': name, 'status': r2.status_code, 'body': r2.json() if r2.status_code==200 else r2.text})
